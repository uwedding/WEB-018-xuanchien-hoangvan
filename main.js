(function ($) {
    ...
    if ($("#wish-form").length) {
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    required: (typeof messageNameRequired != 'undefined') ? messageNameRequired : 'Vui lòng không để trống',
                    minlength: (typeof messageNameMinlength != 'undefined') ? messageNameMinlength : 'Nhập tên ít nhất 3 ký tự.',
                },
                message: {
                    required: (typeof messageContentRequired != 'undefined') ? messageContentRequired : 'Vui lòng không để trống',
                    minlength: (typeof messageContentMinlength != 'undefined') ? messageContentMinlength : 'Lời chúc ít nhất 10 ký tự.',
                },
                relationship: {
                    required: (typeof messageEmailEmail != 'undefined') ? messageEmailEmail : 'Vui lòng không để trống',
                }
            },
    ...
    if ($("#contact-form").length) {
        $("#contact-form").validate({
            ...
            messages: {
                ...
                relationship: "Vui lòng không để trống",
